...
kraken2_otu <- read.delim(file="/crex/proj/sllstore2017021/nobackup/JAELLE/DENTAL_CALCULUS_JENA_GORILLA_181009/P7_kraken2_collapsed_190702/kraken2_otu_table_merged_1908703.txt", sep="\t")
...
kraken2.nodata <- read.delim("tax_reports/tax_report_prok.txt")
...
kraken2.nodata3 <- read.delim("tax_reports/tax_report_virus.txt")
...
write.csv(kraken2_otu_out, "Rout_post_genome_normalisation_190704.csv", quote = FALSE, row.names = TRUE)
