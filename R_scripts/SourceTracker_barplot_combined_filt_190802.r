...
# Unfiltered results, Jena samples, 17/07-19
...
st.all.filt <- read.delim("/home/edvo1850/DENTAL_CALC/DENTAL_CALCULUS_JENA_GORILLA_181009/SourceTracker_combined_filtering_190731/sink_predictions.txt")
names(st.all.filt)
...
ggplot(st.all.filt.m, aes(SampleID,value,fill=variable))+
  ...
  labs(x="Sample", y="Proportion of source", title="Filtered")+
