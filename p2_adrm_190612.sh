...
do
    ...
    #AdapterRemoval --trimns --trimqualities --minquality 30 --minlength 30 --mm 3 --collapse --mate-separator ":" --minalignmentlength 11 --file1 $pair1 --file2 $pair2 --basename $basename 
    echo $pair1
    echo $pair2
    echo $basename
done
